...
Este projeto utiliza **Conventional Commits** para padronizar as mensagens de commit. Todas as mensagens de commit devem seguir este padrão para manter um histórico de alterações claro e organizado. Exemplos: `feat:`, `fix:`, `docs:`, `style:`, `refactor:`, `test:`, `chore:`.
